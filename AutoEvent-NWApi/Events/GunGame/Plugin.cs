...
namespace AutoEvent.Events.GunGame
{
    ...
    {
        public override string Name { get; set; } = Translation.GunGameName;
        public override string Description { get; set; } = Translation.GunGameDescription;
        ...
        public void OnEventStarted()
        {
            ...
            foreach (Player player in Player.GetPlayers())
            {
                ...
                player.SetRole(GunGameRandom.GetRandomRole(), RoleChangeReason.None);
