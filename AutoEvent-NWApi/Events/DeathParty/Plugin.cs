...
namespace AutoEvent.Events.DeathParty
{
    ...
    {
        public override string Name { get; set; } = Translation.DeathName;
        public override string Description { get; set; } = Translation.DeathDescription;
        ...
        {
            TimeGrenade grenade= (TimeGrenade)UnityEngine.Object.Instantiate(item.Projectile, ev.Player.Position, Quaternion.identity);
