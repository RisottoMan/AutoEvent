...
namespace AutoEvent.Events.Deathmatch
{
    ...
    {
        public override string Name { get; set; } = Translation.DeathmatchName;
        public override string Description { get; set; } = Translation.DeathmatchDescription;
        ...
        public void OnEventStarted()
        {
            ...
            foreach (Player player in Player.GetPlayers())
            {
                ...
                {
                    player.SetRole(RoleTypeId.ChaosRifleman, RoleChangeReason.None);
                    player.Position = RandomClass.GetRandomPosition(GameMap);
                }
                count++;
